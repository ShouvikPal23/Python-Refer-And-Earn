...
# Force join handler
@Mukesh.on_message(filters.regex(r"/start \d+"))
    ...
    try:
        try:
            ...
            if is_new_user(msg.from_user.id):
                ...
                await j.delete()
                await Mukesh.send_photo(msg.chat.id, photo=START_IMG, caption=caption2, reply_markup=main_button)

                await Mukesh.send_message(msg.chat.id, text=f"Hey you just got {NEW_USER_BONUS}₹ in your account as new user bonus")
